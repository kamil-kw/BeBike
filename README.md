...
Based on the new trends in the website design, I have used the concept from 1980s – Memphis design, which in this case was making the main page design simultaneously more colour, approach-able and adventurous. 
...
Please find the colours schemes that I used XXXX 

Typography

I decided to use XXXXX as my font of choice with sans serif as my backup font for browsers that might not support XXXXXXX.
The link to the font can be found XXXXX 
...
Github issues were used to create the User stories and group them according to MoSCoW prioriti-zation technique. Link to the project with live issues can be found here.

The issues were than closed automatically when the pull request was linked to the issue.
